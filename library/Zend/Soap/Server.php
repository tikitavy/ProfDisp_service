...
class Zend_Soap_Server implements Zend_Server_Interface
{
    ...
    public function handle($request = null)
    {
        ...
        // Это вывод в лог текста запроса
...
// tiki patch, deleting '<return xsi:type="SOAP-ENC:Struct">' and '</return>'
        ...
        // А тут правим ответ от GetAvailableSlotsRequest
        if (
            strpos($this->_response, 'GetAvailableSlotsRequestResponse') !== false
            AND strpos($this->_response, '<slot SOAP-ENC:arrayType="SOAP-ENC:Struct') !== false
        )
        {
            $this->_response = str_replace( '<slot SOAP-ENC:arrayType="SOAP-ENC:Struct[', '<slot SOAP-ENC:arrayType="ns1:SlotType[', $this->_response);
            $this->_response = str_replace( ']" xsi:type="SOAP-ENC:Array">', ']" xsi:type="ns1:ArrayOfSlotType">', $this->_response);
            $this->_response = str_replace( '<item xsi:type="SOAP-ENC:Struct">', '<item xsi:type="ns1:SlotType">', $this->_response);
        }
// tiki patch end ===========================================================================
